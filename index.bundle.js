...
.grid {
    width: 70vw; height: 60vh; border: 2px solid pink;display: flex; overflow-x: scroll; overflow-y: hidden;
}

.col {
    border: 2px solid green;height: 100%; min-width: 100%; display: flex; justify-content: space-evenly; align-items: center; flex-direction: column;
}
...
`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,sBAAsB;IACtB,UAAU;IACV,SAAS;AACb;;AAEA;IACI,YAAY;IACZ,eAAe;AACnB;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,wEAAwE;IACxE,4BAA4B;IAC5B,4BAA4B;IAC5B,aAAa;IACb,uBAAuB;;IAEvB,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,aAAa;IACb,UAAU;IACV,cAAc;IACd,sBAAsB;IACtB,6BAA6B;IAC7B,mBAAmB;AACvB;;AAEA;IACI,gCAAgC;AACpC;;AAEA;IACI,eAAe;IACf,kBAAkB;AACtB;;AAEA;IACI,WAAW,EAAE,YAAY,EAAE,sBAAsB,CAAC,aAAa,EAAE,kBAAkB,EAAE,kBAAkB;AAC3G;;AAEA;IACI,uBAAuB,CAAC,YAAY,EAAE,eAAe,EAAE,aAAa,EAAE,6BAA6B,EAAE,mBAAmB,EAAE,sBAAsB;AACpJ;;AAEA;IACI;QACI,eAAe;IACnB;AACJ;;AAEA;IACI;QACI,eAAe;IACnB;IACA;QACI,sBAAsB,EAAE,kBAAkB,EAAE,kBAAkB;IAClE;IACA;QACI,gBAAgB;IACpB;AACJ;;AAEA;IACI;QACI,eAAe;IACnB;AACJ","sourcesContent":["* {\n    box-sizing: border-box;\n    padding: 0;\n    margin: 0;\n}\n\nhtml {\n    color: white;\n    font-size: 100%;\n}\n\ninput {\n    width: 6rem;\n}\n\nbody {\n    background: linear-gradient(to right, rgb(49, 4, 75), rgb(11, 180, 202));\n    background-repeat: no-repeat;\n    background-attachment: fixed;\n    height: 100vh;\n    border: 2px solid black;\n\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\n#mainBox {\n    display: flex;\n    height: 30rem;\n    width: 90%;\n    margin: 0 auto;\n    flex-direction: column;\n    justify-content: space-evenly;\n    align-items: center;\n}\n\n.inputHeader {\n    /* Additional styles if needed */\n}\n\n.header {\n    font-size: 2rem;\n    text-align: center;\n}\n\n.grid {\n    width: 70vw; height: 60vh; border: 2px solid pink;display: flex; overflow-x: scroll; overflow-y: hidden;\n}\n\n.col {\n    border: 2px solid green;height: 100%; min-width: 100%; display: flex; justify-content: space-evenly; align-items: center; flex-direction: column;\n}\n\n@media (min-width: 800px) {\n    html {\n        font-size: 30px;\n    }\n}\n\n@media (max-width: 500px) {\n    html {\n        font-size: 18px;\n    }\n    .grid{\n        flex-direction: column; overflow-y: scroll; overflow-x: hidden;\n    }\n    .col{\n        min-height: 100%; \n    }\n}\n\n@media (max-width: 400px) {\n    html {\n        font-size: 12px;\n    }\n}\n"],"sourceRoot":""}]);
// Exports
